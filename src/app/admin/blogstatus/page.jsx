...
const Blogstatus = () => {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        setLoading(true);
        const res = await fetch("https://blog-app-six-blond.vercel.app/api/viewpendingblogs");
  ...
  const updateBlogStatus = async (id, status, remarks) => {
    try {
      const res = await fetch("https://blog-app-six-blond.vercel.app/api/blogstatus", {
        method: "POST",
        headers: {
