...
export const userSchema = z.object({
    fname: z.string({ message: "First name should be a non-empty string" }),
    lname: z.string({ message: "Last name should be a non-empty string" }),
    username: z.string({ message: "Username should be a non-empty string" }),
